...
<html>
    ...
    <body bgcolor="#3A103E">
        <section>
            ...
            <div id="primerpedazo">
                <div id="texto1">
                    <h1>King of Fighters 2002<br> Characters</h1>
                </div>
                <div id="sisaspa">
                    <img src="assets/img/elements/kofcaratula.jpg" id="kofimg" width="290" height="390" alt="">
                </div>
                <div id="personajeskof">
                <?php
				...
				?>		
                    <a href="characters_kof.php?id=<?php echo $row['id'];?>"><img id="whit" height="44px" src="data:image/jpg;base64,<?php echo base64_encode($row['imagen']); ?>"/></a>
