...
<html>
    ...
    <body bgcolor="#3A103E">
        <section>
            ...
            <div id="primerpedazo">
                <div id="texto1">
                    <h1>injustice 2<br> Characters</h1>
                </div>
                <div id="sisaspa">
                    <img src="assets/img/elements/injustice.png" id="sgimg" width="290" height="390" alt="">
                </div>
                <div id="personajesinjc">
                <?php
				...
				?>		
                    <a href="characters_i.php?id=<?php echo $row['id'];?>"><img id="whit" height="44px" src="data:image/jpg;base64,<?php echo base64_encode($row['imagen']); ?>"/></a>
