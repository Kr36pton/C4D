<?php
	...
	$query = "INSERT INTO personajest(id,nombre,imagen,altura,tipo,genero,peso,edad,poder1,poder2,poder3,poder4,poder5,input1,input2,input3,input4,input5) VALUES ('$id','$nombre' ,'$imagen','$altura','$tipo','$genero','$peso','$edad','$poder1','$poder2','$poder3','$poder4','$poder5','$input1','$input2','$input3','$input4','$input5')";
